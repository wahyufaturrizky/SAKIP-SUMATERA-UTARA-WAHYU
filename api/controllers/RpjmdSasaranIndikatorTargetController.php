...
use Yii;
use common\models\RpjmdSasaranIndikatorTarget;
...
/**
 * RpjmdSasaranIndikatorTargetController implements the CRUD actions for RpjmdSasaranIndikatorTarget model.
 */
class RpjmdSasaranIndikatorTargetController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionData($limit=20, $halaman = 1){
        ...
        $query = RpjmdSasaranIndikatorTarget::find();
    ...
    public function actionTambah(){
        ...
        $model = new RpjmdSasaranIndikatorTarget();
    ...
    /**
     * Finds the RpjmdSasaranIndikatorTarget model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $kd_misi
     * @param integer $kd_tujuan
     * @param integer $kd_sasaran
     * @param integer $kd_sasaran_indikator
     * @return RpjmdSasaranIndikatorTarget the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($kd_misi, $kd_tujuan, $kd_sasaran, $kd_sasaran_indikator)
    {
        if (($model = RpjmdSasaranIndikatorTarget::findOne(['kd_misi' => $kd_misi, 'kd_tujuan' => $kd_tujuan, 'kd_sasaran' => $kd_sasaran, 'kd_sasaran_indikator' => $kd_sasaran_indikator])) !== null) {
            return $model;
        }
