...
use Yii;
use common\models\RpjmdRefProgram;
...
/**
 * RpjmdRefProgramController implements the CRUD actions for RpjmdRefProgram model.
 */
class RpjmdRefProgramController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Finds the RpjmdRefProgram model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return RpjmdRefProgram the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RpjmdRefProgram::findOne($id)) !== null) {
            return $model;
        }
