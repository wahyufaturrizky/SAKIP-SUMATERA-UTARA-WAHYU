...
use Yii;
use common\models\RpjmdTaProgram;
...
/**
 * RpjmdTaProgramController implements the CRUD actions for RpjmdTaProgram model.
 */
class RpjmdTaProgramController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Finds the RpjmdTaProgram model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return RpjmdTaProgram the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RpjmdTaProgram::findOne($id)) !== null) {
            return $model;
        }
