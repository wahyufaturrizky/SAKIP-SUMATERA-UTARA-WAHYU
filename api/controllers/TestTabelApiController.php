...
use Yii;
use common\models\TestTabelApi;
...
/**
 * TestTabelApiController implements the CRUD actions for TestTabelApi model.
 */
class TestTabelApiController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Finds the TestTabelApi model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TestTabelApi the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TestTabelApi::findOne($id)) !== null) {
            return $model;
        }
