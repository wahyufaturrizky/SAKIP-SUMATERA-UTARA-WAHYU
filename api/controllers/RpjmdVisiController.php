...
/**
 * RpjmdVisiController implements the CRUD actions for RpjmdVisi model.
 */
class RpjmdVisiController extends Controller
{
    ...
    public function actionData($limit=20, $halaman = 1){
        ...
        foreach ($model as $key => $value):
            $data[$key]['kd_visi'] = $value->kd_visi;
            $data[$key]['visi'] = $value->visi;
        endforeach;
    ...
    /**
     * Finds the RpjmdVisi model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return RpjmdVisi the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RpjmdVisi::findOne($id)) !== null) {
            return $model;
        }
