...
class ApiController extends Controller
{
    ...
    public function actionData($limit=20, $halaman = 1){
        ...
        foreach ($model as $key => $value):
            ...
            $data[$key]['auth_key'] = $value->auth_key;
            $data[$key]['password_hash'] = $value->password_hash;
            $data[$key]['password_reset_token'] = $value->password_reset_token;
            $data[$key]['email'] = $value->email;
            $data[$key]['status'] = $value->status;
            $data[$key]['created_at'] = $value->created_at;
            $data[$key]['updated_at'] = $value->updated_at;
            $data[$key]['verification_token'] = $value->verification_token;
        endforeach;
